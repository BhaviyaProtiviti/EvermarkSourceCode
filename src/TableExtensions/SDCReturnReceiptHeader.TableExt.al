/// <summary>
/// TableExtension SDC Return Receipt Header (ID 50045) extends Record Return Receipt Header.
/// </summary>
tableextension 50045 "SDC Return Receipt Header" extends "Return Receipt Header"
{
    fields
    {
