...
codeunit 50602 "SBC AMC Bank Exp. CT Pre-Map"
{
    ...
    trigger OnRun()
    begin
        FillExportBuffer("Entry No.", "Data Exch. Def Code");
    end;
    ...
    local procedure FillExportBuffer(DataExchEntryNo: Integer; DataExchDefCode: code[20])
    var
                ...
                if (PrevBankAccount <> PerBnkAccGenJournalLine."Bal. Account No.") then begin
                    ...
                    with PaymentExportData do begin
                        ...
                        repeat
                            ...
                            "TIG Description" := GenJournalLine.Description;
                            "TIG Bank Account No." := BankAccount."Bank Account No.";
                            "TIG Bank Branch No." := BankAccount."Bank Branch No.";
                            "TIG Payment Purpose Code" := GenJournalLine."EVM Payment Purpose Code";
                                ...
                                GenJournalLine."Account Type"::Vendor:
                                    begin
                                        ...
                                        if VendorBankAccount.Get(Vendor."No.", GenJournalLine."Recipient Bank Account") then begin
                                            SetRemitToVendorAsRecipient(Vendor, VendorBankAccount, BankAccount);
                            ...
                            "TIG Payment Method Code" := GenJournalLine."Payment Method Code";
