report 50103 "SBC Transfer Orders"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/TransferOrders.rdl';
    ...
    local procedure StandardCostPerCS()
    var
        Item: Record Item;
    ...
    begin
        ...
        if "Transfer Line"."Item No." <> '' then
            if Item.Get("Transfer Line"."Item No.") and (ItemUnitofMeasure.Get("Transfer Line"."Item No.", "Transfer Line"."Unit of Measure Code")) then
                StdCost := (Item."Standard Cost" * ItemUnitofMeasure."Qty. per Unit of Measure") * "Transfer Line".Quantity;
    end;
}
