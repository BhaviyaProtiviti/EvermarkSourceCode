...
// Creation Date: 1/22/2025
// Description: Processing only report to generate negative adjustment for ODW location item journal line based on ODW 846
// Last Modified:

report 50106 "SBC Clear Available Inventory"
{
                    ...
                    field(ItemFilter; ItemFilter)
                    {
                        ...
                        begin
                            ...
                            if ItemPage.RunModal() = Action::LookupOK then begin
                                ItemPage.SetSelectionFilter(ItemTable);
                                ItemFilter += ItemPage.GetSelectionFilter();
                            end;
    ...
    begin
        ...
        ItemLedgerEntry.SetFilter("Location Code", '%1', 'ODW');
    ...
    begin
        ...
        ItemJournalLine."Location Code" := 'ODW';
