report 50101 "SBC Calculate Subcontracts"
{
    ...
    dataset
    {
        dataitem("Work Center"; "Work Center")
        {
            ...
            dataitem("Prod. Order Routing Line"; "Prod. Order Routing Line")
            {
                ...
                begin
                    IF SpecificProdOrder <> '' THEN
                        "Prod. Order Routing Line".SETRANGE("Prod. Order No.", SpecificProdOrder);
                end;
            }
    ...
    procedure SetProdOrder(ProdOrderNo: Code[20])
    begin
        SpecificProdOrder := ProdOrderNo;
    end;

    procedure SBC_GetDirectCost(ReqLine: Record "Requisition Line"; CalledByFieldNo: Integer)
    var
        ...
        IsHandled: Boolean;
    begin
        ReqLine.GetLineWithPrice(LineWithPrice);
        LineWithPrice.SetLine(PriceType::Purchase, ReqLine);
