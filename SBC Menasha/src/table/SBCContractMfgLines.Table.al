/// <summary>
/// Table SBC Contract Mfg. Line (ID 50353).
/// </summary>
table 50353 "SBC Contract Mfg. Line"
{
    Caption = 'SBC Contract Mfg. Line';
    DataClassification = CustomerContent;
    LookupPageId = "SBC Contract Mfg Subform";
    ...
    fields
    {
        ...
        field(5; "SBC Line Error"; Text[250])
        {
            Caption = 'Line Error';
        }
        field(6; "SBC Has Line Error"; Boolean)
        {
            Caption = 'Has Line Error';
        }
        field(7; "SBC Line Processed"; Boolean)
        {
            Caption = 'Line Processed';
        }
