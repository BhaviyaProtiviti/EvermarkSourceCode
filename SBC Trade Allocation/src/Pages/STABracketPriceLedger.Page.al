/// <summary>
/// Page STA Bracket Price Ledger (ID 50220).
/// </summary>
page 50220 "STA Bracket Price Ledger"
{
    ApplicationArea = All;
    Caption = 'SBC Bracket Price Ledger';
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'This is the G/L Entry that this Bracket Price Entry is associated with.';
                    BlankZero = true;
                    Editable = false;
                    Visible = true;
                }
