...
/// </summary>
page 50210 "SBCTA Trade Ledger Preview"
{
    Caption = 'Trade Ledger Preview';
    PageType = List;
    SourceTable = "SBCTA Tr. Budget Ledger Entry";
    AdditionalSearchTerms = 'SBCTA Trade Budget Ledger,SBCTA Tr. Budget Ledger Entry';
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'This is the Amount of the basis entry that was used for Trade Ledger entry.';
                }
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'If a customer-specific Trade Budget Rate was used, the Customer No. will be listed here.';
                }
