report 50145 "SBC Export Electronic Payments"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layout/SBCExportElectronicPayment.rdl';
    WordLayout = './src/report/layout/SBCExportElectronicPayment.docx';
    Caption = 'SBC Export Electronic Payments';
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            DataItemTableView = SORTING("Journal Template Name", "Journal Batch Name", "Line No.") WHERE("Document Type" = FILTER(Payment | Refund));
            ...
            column(Account_No_GenJnlLine; "Account No.")
            {
            }
    ...
    begin
        ...
        if Filter = '' then begin
            ...
            // Filter := "Gen. Journal Line".GetFilter("Journal Template Name")
            Filter := "Gen. Journal Line"."Journal Template Name";
        end;

        if BankAccount.Get(BankAccount."No.") then begin
            BankAccount.TestField(BankAccount.Blocked, false);
            BankAccount.TestField(BankAccount."Export Format");
            BankAccount.TestField(BankAccount."Last Remittance Advice No.");
        end;
