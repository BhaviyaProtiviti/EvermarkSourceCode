...
/// </summary>
report 50083 "SBCEDI Load Document"
{
        ...
        dataitem("LAX EDI Template"; "LAX EDI Template")
        {
            ...
            dataitem(UploadIntegerLoop; Integer)
            {
                ...
                begin
                    ...
                    // LAXEDIWSFileSplit.ProcessCommonReceive();
                    // if CommonReceiveNo = '' then
                    //     CurrReport.Skip();
                    // GlobalLAXEDIWSDocMgmt.GetEDIDoc("LAX EDI Doc. Cabinet Type"::"Common Receive", CommonReceiveNo, 0);
                end;
            }
